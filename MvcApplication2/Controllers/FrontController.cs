...
namespace MvcApplication2.Controllers
{
    public class FrontController : ApiController
    {
        ...
        // GET api/front/5
        public List<DCSFront> Get(string ProjectName, string CabinetName, string AreaName, string LocationName, string CabinetTypeName,int ModelView)
        {
            List<DCSFront> objPHDCSFrontBO = new List<DCSFront>();
            ...
            try
            {
                ...
                DataSet dsTemplate = objDBContext.DownloadDataFromDB(GlobalConstants.GETPHFRONTps, objHybirdTemplate);
